...
- **Gemini CLI**: See `references/gemini-tools.md` for tool equivalents
- **OpenCode**: See `references/opencode-tools.md` for tool equivalents

Codex and Gemini agents should read `AGENTS.md` as their primary instruction file (equivalent to Claude Code's `CLAUDE.md`).
