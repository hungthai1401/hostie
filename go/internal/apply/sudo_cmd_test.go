// sudo_cmd_test.go — covers BuildSudoCmd input validation and SudoApplyCmd
// error paths for hosts-cli-go-mig-p4-sudo-wire-jpr.
//
...
func TestSudoApplyCmd_BuildErrorYieldsMsg(t *testing.T) {
	...
	// Error should originate from BuildSudoCmd validation.
	require.True(t,
